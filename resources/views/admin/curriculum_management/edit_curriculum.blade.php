<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="complab">
                            <option value="0" @if($course->is_complab == 0) selected @endif>No</option>
                            <option value="1" @if($course->is_complab == 1) selected @endif>Yes</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <form action="{{ url('admin/curriculum_management/remove_curricula') }}" method="post" style="display:inline;">
                    @csrf
                    <input type="hidden" name="curriculum_id" value="{{ $course->id }}">
                    <button type="submit" class="btn btn-flat btn-danger">Remove</button>
                </form>
            </div>
        </div>
    </div>
