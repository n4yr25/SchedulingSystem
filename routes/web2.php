...
Route::get('/admin/reports/print_sections_occupied/{room}','Admin\ReportController@print_section_occupied');
...
Route::post('/admin/database_backup/import','Admin\DatabaseBackupController@import');
